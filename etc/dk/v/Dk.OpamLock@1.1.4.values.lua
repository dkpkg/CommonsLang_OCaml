local M = {
  id = "CommonsLang_OCaml.Dk.OpamLock@1.1.4"
}
...
CommonsLang_OCaml__Dk_OpamLock__1_1_4 = {}
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.iswhite(c)
...
-- switch).
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.trim(s)
  if s == nil then return "" end
  local n = string.len(s)
  local a = 1
  while a <= n and CommonsLang_OCaml__Dk_OpamLock__1_1_4.iswhite(string.sub(s, a, a)) do a = a + 1 end
  if a > n then return "" end
  local b = n
  while b >= 1 and CommonsLang_OCaml__Dk_OpamLock__1_1_4.iswhite(string.sub(s, b, b)) do b = b - 1 end
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.join(tbl, sep)
  local r = nil
  local i = 1
  while tbl[i] ~= nil do
    if r == nil then
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.set_from_list(tbl)
  local set = {}
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.dirname(p)
...
function uirules.Solve(command, request, continue_)
  local H = CommonsLang_OCaml__Dk_OpamLock__1_1_4
  if command == "ui" then
    print("CommonsLang_OCaml.Dk.OpamLock@1.1.4: lock written.")
    return
  end
  ...
  local args = { bc, "solve", "--opam", opamexe, "--work-dir", workdir, "--pins-file", pinsfile,
    "--tool", "CommonsLang_OCaml.Dk.OpamLock@1.1.4" }
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.indexof_char(s, ch)
  local i = 1
  local n = string.len(s)
  while i <= n do
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.numstr(v)
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.modsegment(name)
  local out = ""
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.is_host_tool(name)
...
CommonsLang_OCaml__Dk_OpamLock__1_1_4.DKML_PROVIDED = {
...
CommonsLang_OCaml__Dk_OpamLock__1_1_4.DKML_SLOTS = {
...
function CommonsLang_OCaml__Dk_OpamLock__1_1_4.driver_visit(byname, provided, name, seen, order)
  local H = CommonsLang_OCaml__Dk_OpamLock__1_1_4
...
function uirules.GenerateDriver(command, request)
  local H = CommonsLang_OCaml__Dk_OpamLock__1_1_4
  if command == "ui" then
    print("CommonsLang_OCaml.Dk.OpamLock@1.1.4: driver written.")
    return
  end
  if command ~= "submit" then return end
