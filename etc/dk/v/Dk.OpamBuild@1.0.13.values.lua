local M = {
  id = "CommonsLang_OCaml.Dk.OpamBuild@1.0.13"
}
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_13 = {}
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.NULL = {}

rules, _uirules = build.newrules(M)

CommonsLang_OCaml__Dk_OpamBuild__1_0_13.SLOTS = {
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.ABIS = {
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED = {}
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["ocaml"] = "ocaml"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["ocaml-base-compiler"] = "ocaml-base-compiler"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["ocaml-config"] = "ocaml-config"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["ocaml-options-vanilla"] = "ocaml-options-vanilla"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["base-unix"] = "base-unix"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["base-threads"] = "base-threads"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["base-bigarray"] = "base-bigarray"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["dune"] = "dune"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["flexdll"] = "flexdll"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["conf-mingw-w64-gcc-x86_64"] = "conf-mingw-w64-gcc-x86_64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["host-arch-x86_64"] = "host-arch-x86_64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["host-arch-x86_32"] = "host-arch-x86_32"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["host-arch-arm64"] = "host-arch-arm64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["host-system-mingw"] = "host-system-mingw"
CommonsLang_OCaml__Dk_OpamBuild__1_0_13.PROVIDED["host-system-other"] = "host-system-other"

function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.iswhite(c)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.is_pure_int(s)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.numstr(v)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.join(tbl, sep)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.indexof(s, ch, i)
  local n = string.len(s)
  local j = i
  while j <= n do
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.lastindexof(s, ch)
  local n = string.len(s)
  local j = n
  while j >= 1 do
    if string.sub(s, j, j) == ch then return j end
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.endswith(s, suffix)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.modsegment(name)
  local out = ""
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.tokenize_field(raw)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_13
  local groups = {}
  local bare = { toks = {} }
  local cur = nil
  local lasttok = nil
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.version_parts(v)
  local out = {}
  local seg = ""
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.version_ge(a, b)
  local pa = CommonsLang_OCaml__Dk_OpamBuild__1_0_13.version_parts(a)
  local pb = CommonsLang_OCaml__Dk_OpamBuild__1_0_13.version_parts(b)
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.eval_filter(ftext, fenv, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_13
  local words = {}
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.filter_atom(words, st, fenv, pkg, ftext, skipeval)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_13
  local negate = nil
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.interpolate(s, vars, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_13
  local out = ""
  local i = 1
  local n = string.len(s)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.field_to_argvs(raw, fenv, vars, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_13
  local argvs = {}
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.shq(s)
  local out = "'"
  local i = 1
  local n = string.len(s)
  while i <= n do
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.abi_os(abi)
...
-- contains the latter).
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.abi_arch(abi)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.percommand_abi(coreutils, wrapperfetch, msys2dash, argv, abi, targetabi, ocaml, dune)
  local shell = "/bin/sh"
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_13.hermeticize_argvs(argvs)
  local out = {}
  local i = 1
...
function rules.F_BuildLockedPackage(command, request, continue_)
  ...
  -- 7zz is still used to CREATE the output install.zip (`a`, below); the source
  -- and dependency EXTRACTION moved to precommands that use dk builtins.
  ...
  local commands = {}
  -- 1.0.13: stage the dependency prefixes into p/ and the source into s/ with
  -- dk builtins (merge-object / install-object / F_TarToZip), never 7zz -- so a
  -- source tarball carrying a symlink whose target escapes the extraction root
  -- (menhir's demos/) no longer fails the build on Windows (F_TarToZip's Windows
  -- path tolerates it via -snl-). Precommands complete before function_ runs.
  ...
  while closure[ci2] ~= nil do
    ...
    -- Merge each dependency's install.zip into the shared prefix p/. merge-object
    -- (not install-object) because every dependency writes into the same p/;
    -- distinct opam packages install into distinct lib/<pkg>/ + bin entries, so
    -- no two merges write the same file.
    table.insert(precommands_private,
      "merge-object " .. depmodver .. " -s ${SLOTNAME.request} -m ./install.zip -d p")
    ci2 = ci2 + 1
  end

  -- Stage the source into s/ as a precommand, with dk builtins, preserving the
  -- single top-level <pkg>-<version>/ directory (the build wrapper descends into
  -- that sole directory, a uniform shape across all platforms). Three cases:
  --  * local package ("local":"t"): its source is a single shared
  --    localized-source object (the driver's `localsrc=MODULE@VERSION`, e.g.
  --    dk0's MlFront tree from CommonsBase_Dk.Dk0.MlFrontSource), an
  --    output.zip -- install it directly.
  --  * external zip source (arch == "zip"): the per-package archive asset from
  --    the synthesized .Src bundle is already a zip -- get-asset extracts it.
  --  * external tarball (tgz/txz/tbz/tar): convert it to a zip object with the
  --    shared CommonsBase_Std.Extract.F_TarToZip rule, then install that zip.
  --    F_TarToZip's Windows path tolerates a source that ships a symlink whose
  --    target escapes the extraction root (menhir's demos/) via -snl-; a plain
  --    7zz extraction would refuse the "dangerous link" and fail the build.
  if is_local then
    ...
    table.insert(precommands_private,
      "install-object " .. localsrc .. " -s ${SLOTNAME.request} -m ./output.zip -d s")
  elseif arch == "zip" then
    table.insert(precommands_private,
      "get-asset " .. srcbundle .. " -p " .. srcname .. " -d s")
  else
    local srczip = modpath .. ".SrcZip@" .. modversion
    table.insert(precommands_private,
      "post-object CommonsBase_Std.Extract.F_TarToZip@0.3.1 -f ignored.zip modver=" .. srczip
      .. " tarmodver=" .. srcbundle .. " tarassetpath=" .. srcname)
    table.insert(precommands_private,
      "install-object " .. srczip .. " -s ${SLOTNAME.request} -m ./output.zip -d s")
  end
  ...
  local wrapperfetch = "$(get-asset CommonsLang_OCaml.Apparatus.OpamBuildWrapper@1.0.7 -p assets/opam/build-locked-package-v5.sh -f build-wrapper.sh)"
