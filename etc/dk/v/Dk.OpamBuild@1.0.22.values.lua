local M = {
  id = "CommonsLang_OCaml.Dk.OpamBuild@1.0.22"
}
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_22 = {}
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.NULL = {}
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.WINPATHS = {}

rules, _uirules = build.newrules(M)

CommonsLang_OCaml__Dk_OpamBuild__1_0_22.SLOTS = {
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.ABIS = {
...
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED = {}
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["ocaml"] = "ocaml"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["ocaml-base-compiler"] = "ocaml-base-compiler"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["ocaml-config"] = "ocaml-config"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["ocaml-options-vanilla"] = "ocaml-options-vanilla"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["base-unix"] = "base-unix"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["base-threads"] = "base-threads"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["base-bigarray"] = "base-bigarray"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["dune"] = "dune"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["flexdll"] = "flexdll"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["conf-mingw-w64-gcc-x86_64"] = "conf-mingw-w64-gcc-x86_64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["host-arch-x86_64"] = "host-arch-x86_64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["host-arch-x86_32"] = "host-arch-x86_32"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["host-arch-arm64"] = "host-arch-arm64"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["host-system-mingw"] = "host-system-mingw"
CommonsLang_OCaml__Dk_OpamBuild__1_0_22.PROVIDED["host-system-other"] = "host-system-other"

function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.iswhite(c)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.is_pure_int(s)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.numstr(v)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.join(tbl, sep)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.indexof(s, ch, i)
  local n = string.len(s)
  local j = i
  while j <= n do
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.lastindexof(s, ch)
  local n = string.len(s)
  local j = n
  while j >= 1 do
    if string.sub(s, j, j) == ch then return j end
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.endswith(s, suffix)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.modsegment(name)
  local out = ""
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.tokenize_field(raw)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local groups = {}
  local bare = { toks = {} }
  local cur = nil
  local lasttok = nil
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.version_parts(v)
  local out = {}
  local seg = ""
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.version_ge(a, b)
  local pa = CommonsLang_OCaml__Dk_OpamBuild__1_0_22.version_parts(a)
  local pb = CommonsLang_OCaml__Dk_OpamBuild__1_0_22.version_parts(b)
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.eval_filter(ftext, fenv, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local words = {}
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.filter_atom(words, st, fenv, pkg, ftext, skipeval)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local negate = nil
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.interpolate(s, vars, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local out = ""
  local i = 1
  local n = string.len(s)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.field_to_argvs(raw, fenv, vars, pkg)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local argvs = {}
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.shq(s)
  local out = "'"
  local i = 1
  local n = string.len(s)
  while i <= n do
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.abi_os(abi)
...
-- contains the latter).
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.abi_arch(abi)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.percommand_abi(coreutils, wrapperfetch, msys2dash, argv, abi, targetabi, ocaml, dune)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local shell = "/bin/sh"
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.hermeticize_argvs(argvs)
  local out = {}
  local i = 1
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.is_host_tool(name)
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.driver_visit(byname, provided, name, seen, order)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
...
function CommonsLang_OCaml__Dk_OpamBuild__1_0_22.synth_package(a)
  local H = CommonsLang_OCaml__Dk_OpamBuild__1_0_22
  local pkg = a.pkg
  local entry = a.entry
