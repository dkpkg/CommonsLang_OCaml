...
let reloc_override name =
  ...
  | "ocamlfind" ->
      ...
      Some {
        r_url = "https://github.com/jonahbeckford/ocamlfind/releases/download/1.9.8+reloc+dk-r1/src.tar.gz";
  ...
  | "ocamlbuild" ->
      ...
      Some {
        r_url = "https://github.com/jonahbeckford/ocamlbuild/releases/download/0.14.3+reloc+dk-r1/src.tar.gz";
